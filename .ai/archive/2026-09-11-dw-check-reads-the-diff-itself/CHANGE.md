...
- The close caught the floor stated as its own negation: `under 50 lines` inverted to `more than 50`
  rather than `50 or more`, flipping the behaviour at exactly 50 lines. Fixed in the closing commit.
