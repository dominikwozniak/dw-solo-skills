...
| [`dw-land`](skills/dw-land/SKILL.md)       | One thin verdict, then promote what's durable and archive  | `bare` · `codex` · `close`                                     | `docs/decisions/` · `CONTEXT.md` · backlog · `.ai/archive/` |
